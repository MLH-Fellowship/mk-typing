  ...
  <div>
    ...
    <v-container class="mt-5">
      <div class="center">
        ...
        <v-alert :value="alert" type="error" class="mt-5">
          Incorrect!
        </v-alert>
    ...
    beginStage: function () {
      setInterval(() => {
        ...
        if (
          ...
          this.currentStage <= 2 && this.answer == this.stages[this.currentStage - 1].text
        ) {
          this.moveOnToNextStage();
        }
        if (this.stages[this.currentStage - 1].counter == 0 && this.answer !== this.stages[this.currentStage - 1].text ) {
